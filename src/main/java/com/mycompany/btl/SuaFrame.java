 ...
 * @author tungc
 */
public class SuaFrame extends java.awt.Frame {
    ...
    /**
     * Creates new form SuaFrame
     */
    public SuaFrame(String name, String title, String[][] input, DanhSachPanel pn, int model_index, String[] choice_input) {
        ...
        id_lble.setText("Mã");
        id_tf.setText(String.valueOf(model_index));
